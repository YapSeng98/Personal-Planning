...
// Full URL : https://<instance>.service-now.com/api/x_887486_persona_0/planner/sync/pull?since=...
//
...
(function process(request, response) {
    ...
    var FIELD_MAPS = {
        task: {
            ...
            reminder_days_before: 'reminderDaysBefore', recurrence: 'recurrence', series_id: 'seriesId'
        },
        habit: {
